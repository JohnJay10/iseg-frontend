...
const Forums = () => {
  ...
  const technicalForums = [
    ...
    },
    {
      ...
      organizers: [
        { name: 'Prof. Shi Bin (President, ISEG)', email: 'shibin@nju.edu.cn', phone: '' },
  ...
  const specialSessions = [
    {
      code: 'OSS.1',
      title: 'ISEG EXPOSITIONAL SPECIAL SESSION',
      organization: 'International Society of Environmental Geotechnology (ISEG)',
      fullDescription: 'The International Society of Environmental Geotechnology (ISEG) is an international professional organizations that is a multidisciplinary organization dedicated to solving global environmental challenges through advanced engineering practices. The international society bridges technical earth sciences with social science policy to address critical geo-ecosystem issues. Since establishing its international symposium series, ISEG has coordinated cross-border research, academic forums, and field demonstrations focused on contaminated site remediation, geohazard mechanics, climate change adaptation, and sustainable development frameworks. By connecting academics, engineers, and regulators across its major regional hubs, the society translates raw subsurface data into actionable environmental policies and green engineering solutions. It is one of the major organizers of this ISEG/GGSD 2026 Mega Symposium. Its membership is open to all professionals in the earth sciences, geoengineering fields, ecological and environmental fields as well as intersections of these fields with other disciplines that pertain global sustainable development. ISEG was co-founded by Prof. Hilary I. Inyang and Prof. Hsai Yai Fang at the University of Massachusetts in 1996 and later registered as a bonafide international professional society with its global headquarters at the University of North Carolina Charlotte in 2004 with Prof. Hilary I. Inyang as its first President. ISEG is presently headquartered in Nanjing University in Nanjing, China with Prof. Shi Bin of Nanjing University and Prof. Chao-Sheng Tang of the same university as President and Secretary-General, respectively. In this session, ISEG leaders will review the history of the organization and welcome new members into ISEG with information on future plans of symposia, special editions of journals, webinars, special study and research opportunities and other benefits.',
      organizers: [
        { name: 'Prof. Chao-Sheng Tang', email: 'tangchaosheng@nju.edu.cn', phone: '+86-25-83597888' },
    ...
    <main>
      <section className="page-header">
        <div className="container">
          ...
          <p>Knowledge Exchange and Collaborative Discussions at ISEG/GGSD-2026</p>
        </div>
      </section>
